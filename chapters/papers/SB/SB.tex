...
\resizebox{\columnwidth}{!}{%
    \begin{tikzpicture}[ image/.style = {text width=0.75\textwidth,
    ...
    \def\myanchorshift{-0.6cm}
\node [image] (frame1)
{\input{chapters/papers/SB/figures/fig-3-surfaces-placeholder/surface_roughness-boxplot}};
% \node [above left=of frame1] {A}; %  at (-4,2)
\node[anchor=south west, above left=\myanchorshift] at (frame1.north west) {\large A};
\node [image,right=of frame1] (frame2) 
{\input{chapters/papers/SB/figures/fig-3-surfaces-placeholder/surface_materials-boxplot}};
