...
\begin{figure}[!t]
\centering
\includegraphics[width=1\columnwidth]{figures/fig-1-overview/fig-1-overview.eps}
...
\begin{figure*}[!t]
\centering
\includegraphics{figures/fig-3-sampler-pump/fig-3-sampler-pump-v02.eps}
...
\begin{figure}[!t]
\centering
\input{figures/sampler-weight-breakdown/sampler-weight-breakdown.tikz}
...
\includegraphics[width=0.99\textwidth]{figures/fig-4-results/figure_4_pumps.eps}
% \vspace{-6em}
...
\begin{figure}[!hpt]
\centering
\includegraphics[width=1\columnwidth]{figures/fig-6-retrieval-success/fig-6-retrieval-success.eps}
