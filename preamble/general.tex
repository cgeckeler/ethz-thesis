...
%%-------CG Custom------
\usepackage{gensymb}    % for \degree (origami gripper, Advanced Intelligent System Layout)
...
% \usepackage{acro} % for acronynms

\pgfplotsset{
    customboxplotstyle/.style={
    ...
    yticklabels={VLOS 1, VLOS 2, BVLOS 1, BVLOS 2},
    ...
    customaddplotstyle/.style={
    boxplot, mark=*, fill, draw=black,
    },
    % customtablestyle/.style={
    % y index=\n, col sep=comma,        % Doesn't work since local variable
    % }
}

\usepackage{multirow} % For tables in OBR (RAL)

%-- things for eProbe (ACS) (TODO: Needed?)
\usepackage{booktabs}
\usepackage[table]{}
\usepackage{makecell}

\usepackage{authblk}
% \newcommand*\affilsize{\small}
% \newcommand*\authorsize{\large}
% \newcommand*\emailsize{\normalsize}
% \newcommand*\titlesize{\LARGE}
% *** ACRONYM PACKAGES ***
\usepackage[acronym]{glossaries}
\input{chapters/papers/EP/acronyms}
\input{chapters/papers/UR/acronyms_UR}

% --- Snailbot things (Wiley Advanced Intelligent Systems)
\usepackage{wrapfig}
...
\newcommand{\nn}[1]{{\color{green} Niklas: #1}}
\newcommand{\cg}[1]{{\color{blue} Christian: #1}}
